...
export default function EventItem() {
  ...
  return (
    events.map((event, index) => (
      <div key={index} className='event__item flex flex-col rounded-md shadow-md hover:shadow-lg  hover:transition hover:scale-105 hover:delay-100 bg'>
        ...
        <div className="event__item_detail px-5 py-5">
          ...
          <p className='event__item_date text-xs font-normal mt-1'>Tanggal : {event.date}</p>
          <p className="event__item_capacity text-xs font-normal mt-1">Kapasitas : {event.capacity}</p>
