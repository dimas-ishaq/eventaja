    ...
    <div className="w-full flex flex-col md:mt-2">
      ...
      <div className="m-3 flex flex-col">
        <div className="flex flex-col items-center w-full">
          <div
            className={`w-full ml-2.5  justify-center items-center  ${isOpen ? 'hidden' : 'flex'} `}
          >
            <input
              type="search"
              name="search_blog"
              id="search_blog"
              className="px-3 py-2.5 w-full rounded-md outline-1 outline-violet-500 border-1 bg-gray-200/80"
              placeholder="Search blogs here ..."
            />
            <button
              type="button"
              className="px-3 py-2.5 ml-2 bg-violet-700 hover:bg-violet-600 rounded"
            >
          ...
          <div className="flex justify-between border-b border-gray-300 w-full mt-5 pb-5">
            <h5 className="text-lg font-semibold">
              {isOpen ? 'Buat Post' : 'Post'}
            </h5>
            <button
              type="button"
              className="bg-pink-700 hover:bg-pink-600 px-2 py-1 text-sm font-normal text-white rounded-sm"
