...
async function getData() {
  const session = await getServerSession(authOptions);
    const res = await supabase.from('tbl_eo').select().eq('user_id',session?.user?.id);
  ...
  const services = [
    {
      ...
      description:
        'Comprehensive wedding planning services to ensure your special day is perfect.',
      price: 1500,
      user_id: 3,
      ...
      cooperation_policy:
        'Submit proposal 2 months before the event. Full payment required upon agreement.',
    },
    {
      id: 2,
      title: 'Corporate Event Management',
      description:
        'Professional management of corporate events, including conferences and seminars.',
      price: 2500,
      user_id: 4,
      ...
      cooperation_policy:
        'Submit proposal 3 months before the event. 50% deposit required upon agreement.',
    },
    {
      id: 3,
      title: 'Birthday Party Planning',
      description:
        'Creative and fun birthday party planning services for all ages.',
      price: 500,
      user_id: 5,
      ...
      cooperation_policy:
        'Submit proposal 1 month before the event. Full payment required upon agreement.',
    },
    {
      id: 4,
      title: 'Catering Services',
      description:
        'Delicious catering services for any event, from small gatherings to large celebrations.',
      price: 1000,
      user_id: 2,
      ...
      cooperation_policy:
        'Submit proposal 2 months before the event. 50% deposit required upon agreement.',
    },
    {
      id: 5,
      title: 'Photography and Videography',
      description:
        "Professional photography and videography services to capture your event's best moments.",
      price: 800,
      user_id: 1,
    ...
    },
    {
      ...
      description:
        'Top-notch sound and lighting services to enhance your event experience.',
      price: 1200,
      user_id: 3,
    ...
    },
    {
      ...
      description:
        'Beautiful and customized venue decoration services to match your event theme.',
      price: 700,
      user_id: 4,
    ...
    },
    {
      ...
      description:
        'Booking services for bands, DJs, and entertainers to keep your guests entertained.',
      price: 900,
      user_id: 5,
    ...
    },
    {
      ...
      description:
        'Reliable transportation services to ensure your guests arrive on time.',
      price: 600,
      user_id: 2,
    ...
    },
    {
      ...
      description:
        'Professional event staffing services to ensure your event runs smoothly.',
      price: 1100,
      user_id: 1,
    ...
    <div className="w-full flex flex-col md:mt-2">
      <div className="flex flex-col-reverse md:flex-row md:justify-between items-start p-3">
        <div className="flex flex-col mt-2 md:mt-0">
          ...
          <p className="text-sm mt-2">
            Buat, Edit, dan Kelola Event Organizer Anda
          </p>
        </div>
      ...
      <div className="flex flex-col p-3">
        ...
        <div className="flex flex-col items-end mt-5">
          <Modal
            children={<EventOrganizerInput />}
            btnName={'+ Buat Event Organizer'}
          />
        </div>
        <TableEventOrganizer eventsOrganizer={res.data} />
      </div>
    </div>
  );
}
